...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoidml2ZWtnZW5pdXMiLCJhIjoiY204NDQ3dWdhMW9iNTJxc2F3dGFxN28wZSJ9.goo4_765HCGhR4ViGLSrdg';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          domain = window.location.origin;
          _context.prev = 1;
          url = type === 'password' ? "".concat(domain, "/api/v1/users/updateMyPassword") : "".concat(domain, "/api/v1/users/updateUserData");
          _context.next = 5;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(formData) {
    var formDataEntries, _iterator, _step, pair, domain, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              pair = _step.value;
              formDataEntries.push("".concat(pair[0], ": ").concat(pair[1]));
            }
          } catch (err) {
            _iterator.e(err);
          } finally {
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(domain, "/api/v1/users/signup"),
            data: formData
          });
        case 8:
          res = _context.sent;
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Signup successful! Redirecting...');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
        ...
        case 13:
          _context.prev = 13;
          _context.t0 = _context["catch"](0);
          console.error('Error:', _context.t0.response ? _context.t0.response.data : _context.t0.message);
          (0, _alerts.showAlert)('error', _context.t0.response ? _context.t0.response.data.message : 'An error occurred');
        case 17:
        case "end":
          return _context.stop();
      }
...
},{"./mapbox":"mapbox.js","./login":"login.js","./updateSettings":"updateSettings.js","./signup":"signup.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
